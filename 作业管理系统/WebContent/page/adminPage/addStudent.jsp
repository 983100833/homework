			...
			<div class="content">
				<div class="contBox bgf9">
					...
					<div class="prolistHead clearfix">
						<a class="prolist1" href="StudentPage" target="_self">学生信息</a>
						<a class="prolist2 active" href="AddStudentPage" target="_self">添加学生</a>
				<!--Main Start!-->
		<div id="main">
			<div class="content">
				<div class="contBox bgf9">
					...
					<div class="prolistApplyW">
						<div class="prolistApplyInner clearfix">
							...
							<div class="prolistApplyCont">
								<input type="text" name="stuId" id="" value="" placeholder="" />
							</div>
						</div>
						<div class="prolistApplyInner clearfix">
							<h2>姓名</h2>
							<div class="prolistApplyCont">
								<input type="text" name="stuName" id="" value="" placeholder=""/>
							</div>
						</div>
						<div class="prolistApplyInner clearfix">
							<h2>性别</h2>
							<div class="prolistApplyCont">
								<input type="text" name="stuSex" id="" value="" placeholder=""/>
							</div>
						</div>
						<div class="prolistApplyInner clearfix">
							<h2>学院</h2>
