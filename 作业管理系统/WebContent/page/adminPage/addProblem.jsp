			...
			<div class="content">
				<div class="contBox bgf9">
					...
					<div class="prolistHead clearfix">
						<a class="prolist1" href="ProblemPage" target="_self">题库列表</a>
						<a class="prolist2 active" href="AddProblemPage" target="_self">添加题目</a>
				<!--Main Start!-->
		<div id="main">
			<div class="content">
				<div class="contBox bgf9">
					...
					<div class="prolistApplyW">
						<div class="prolistApplyInner clearfix">
							...
							<div class="prolistApplyCont">
								<input type="text" name="problemId" id="" value="" placeholder="" />
							</div>
						</div>
						<div class="prolistApplyInner clearfix">
							<h2>题目</h2>
						...
						<div class="prolistApplyInner clearfix">
							<h2>答案</h2>
							<div class="prolistApplyCont">
								<input type="text" name="answer" id="" value="" placeholder=""/>
							</div>
						</div>
