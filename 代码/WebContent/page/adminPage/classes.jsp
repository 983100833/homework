...
<%@page import="com.hm_ms.bean.Group"%>
			...
			<div class="content">
				<div class="contBox bgf9">
					...
					<div class="prolistHead clearfix">
						<a class="prolist1 active" href="ClassesPage" target="_self">班级列表</a>
						<a class="prolist2" href="AddClassesPage">添加班级</a>
					</div>
					<div class="prolistSearch clearfix">
						...
						<form action="findClasses" method="post">
						<div class="buttOper blacklist clearfix">
						<div class="buttProject selectW">
							<input type="text" name="classesId" id="" value="" placeholder="班级号"/>
						</div>
						
						<div class="prolistSearchW">

<!-- 							<input type="text" name="problemId" id="" value="" placeholder="班级号"/> -->
...
<%
   List <Group>list = (List)request.getAttribute("classes");
%>	
					<div class="prolist buttW">
						<table border="1" cellspacing="0" cellpadding="0" border-collapse="collapse" width="100%">
							...
							<tr>
							<td><%=pb.getGroupId() %></td>
							<td><%=pb.getGroupName() %></td>
							<td><%=pb.getGroupNumber() %></td>
							<td><%=pb.getCollege() %></td>
							<td><a class="prolist2" href="openAlterClasses?classesId=<%=pb.getGroupId()%>
							&classesName=<%=pb.getGroupName() %>&classesNum=<%=pb.getGroupNumber() %>
							&colName=<%=pb.getCollege() %>">修改班级</a>
							<a class="prolist2" href="openDeleteClasses?classesId=<%=pb.getGroupId()%>">删除班级</a></td>
							</tr>
						<%
							}
							%>
