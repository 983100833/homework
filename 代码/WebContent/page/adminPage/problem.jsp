...
<%@page import="com.hm_ms.bean.Problem"%>
			...
			<div class="content">
				<div class="contBox bgf9">
					...
					<div class="prolistHead clearfix">
						<a class="prolist1 active" href="ProblemPage" target="_self">题库列表</a>
						<a class="prolist2" href="AddProblemPage">添加题目</a>
					</div>
					<div class="prolistSearch clearfix">
						...
						<form action="findProblem" method="post">
						<div class="buttOper blacklist clearfix">
						<div class="buttProject selectW">
							<input type="text" name="problemContent" id="" value="" placeholder="题目"/>
						</div>
						
						<div class="prolistSearchW">

							<input type="text" name="problemId" id="" value="" placeholder="题号"/>
...
<%
   List <Problem>list = (List)request.getAttribute("problem");
%>	
					<div class="prolist buttW">
						<table border="1" cellspacing="0" cellpadding="0" border-collapse="collapse" width="100%">
							...
							%>
							<tr>
							<td><%=pb.getProblemId() %></td>
							<td><%=pb.getProblemContent() %></td>
							<td><%=pb.getAnswerContent() %></td>
							<td><a class="prolist2" href="openAlterProblem?problemId=<%=pb.getProblemId()%>
							&problemContent=<%=pb.getProblemContent() %>&answer=<%=pb.getAnswerContent() %>">修改题目</a>
							<a class="prolist2" href="openDeleteProblem?problemId=<%=pb.getProblemId()%>">删除题目</a></td>
							</tr>
						<%
							}
							%>
