				...
				<div class="contBox bgf9">
					...
					<div class="personBox">
						<div class="personTit">
							...
							<a href="alterStuPwd?stuId=<%=stuId %>" target="_self">密码修改</a>
						</div>
...
<!-- 									<input type="submit" name="" id="sub" value="修改头像" /> -->
						...
						for(Student s : list){
					%>
						<p><span class="personWLeft personWLeft1">学号:</span><span class="personWCenter"><%=s.getStudentId() %></span></p>
							<p><span class="personWLeft personWLeft1">姓名:</span><span class="personWCenter"><%=s.getStudentName() %></span></p>
							<p><span class="personWLeft personWLeft1">性别</span><span class="personWCenter"><%=s.getStuSex() %></span></p>
